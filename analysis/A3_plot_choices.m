...
%   
    ...
    %         bin_simu(subj). items3_2{i} = items3(pos_bin2);
            ...
            m_h0_3_1(subj,i) = nanmean(bin_simu(subj). H0_choice1_3{i});
    ...
    %         bin_simu(subj). items4_2{i} = items4(pos_bin2);
            ...
            m_h0_4_1(subj,i) = nanmean(bin_simu(subj). H0_choice1_4{i});
    ...
    %         bin_simu(subj). items5_2{i} = items5(pos_bin2);
            ...
            m_h0_5_1(subj,i) = nanmean(bin_simu(subj). H0_choice1_5{i});
    ...
    %         bin_simu(subj). items6_2{i} = items6(pos_bin2);
            ...
            m_h0_6_1(subj,i) = nanmean(bin_simu(subj). H0_choice1_6{i});
...
% plot the probability of chosing the best option
    ...
    elseif cate_number == 15
        title (['choice all Category'])
    end

    cd(plotsdir);saveas(gcf,['choice_cate_',num2str(cate_number),'.tif']);
end
