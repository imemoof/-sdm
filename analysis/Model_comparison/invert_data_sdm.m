...
for s = 1:N_sub
    ...
    if model_n ~= 1
        ...
        priors.muX0 = nanmean(myratingfile.rating_all);
...
param = struct('Name',[func2str(modeles{1}),'_VBA'],'Val_param_obs',obs_param_all_r,'Val_param_evo',evo_param_all_r,'Priors',prior,'Var_priors',var_prior,'Rating_model_evidence',model_evidence_r,...
