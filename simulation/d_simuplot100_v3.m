...
%          trial_simu(subj). V_hzerrepea = [per_trial(subj,categories).ratingsOrdered];    % the ratings in the above defined order, [ 40, 20, 30]
...
% figure 
% subplot(1,2,1), hold on, set(gca,'fontsize',20) %,ylim([0.75, 1])
% errorbar(nanmean(mm_h0_3_2),nanmean(mstd_h0_3_2),'Color','b', 'LineWidth',plotwidth)
% errorbar(nanmean(mm_h0_4_2),nanmean(mstd_h0_4_2),'Color','m', 'LineWidth',plotwidth)
% errorbar(nanmean(mm_h0_5_2),nanmean(mstd_h0_5_2),'Color','g', 'LineWidth',plotwidth)
% errorbar(nanmean(mm_h0_6_2),nanmean(mstd_h0_6_2),'Color','r', 'LineWidth',plotwidth)
% legend('3 items','4 items','5 items', '6 items');
% ylabel ('2nd best option choice proba')
% title ('100 Simulation of H0')
% 
% subplot(1,2,2), hold on,set(gca,'fontsize',20) %,ylim([0.75, 1])
% errorbar(nanmean(mm_h1_3_2),nanmean(mstd_h1_3_2),'Color','b', 'LineWidth',plotwidth)
% errorbar(nanmean(mm_h1_4_2),nanmean(mstd_h1_4_2),'Color','m', 'LineWidth',plotwidth)
% errorbar(nanmean(mm_h1_5_2),nanmean(mstd_h1_5_2),'Color','g', 'LineWidth',plotwidth)
% errorbar(nanmean(mm_h1_6_2),nanmean(mstd_h1_6_2),'Color','r', 'LineWidth',plotwidth)
% 
% legend('3 items','4 items','5 items', '6 items');
% ylabel ('2nd best option choice proba')
% title (['100 Simulation of H1 (betaC = ',num2str(beta),')'])
% set(gcf, 'Position', [0, 0, 1600, 600])
