function param = invert_simulations_v2(beta, dataset, model_n, dispo, sub)
...
for s = 1:k
    ...
    for mod=1:length(modeles)        
        ...
        u_r = [choice_index', itemnum',values,highpos',chosen_value']';  % 180*10 matrix, values  (3-8)
